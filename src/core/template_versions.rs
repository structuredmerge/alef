...
pub mod npm {
    ...
    // pair), so this const is tracked with its own Renovate marker but must always carry the
...
pub mod maven {
    ...
    pub const CHECKSTYLE: &str = "14.1.0";
    ...
    pub const GRADLE_VERSIONS_PLUGIN: &str = "0.64.0";
...
pub mod precommit {
    pub const ALEF_REV: &str = "v0.93.1";
