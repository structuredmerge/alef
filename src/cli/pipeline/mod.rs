...
pub use generate::{
    ...
    generate_stubs, generate_sweep_roots, managed_generated_files, managed_output_paths, normalize_content,
    normalize_foreign_tool_content, readme, reconcile_managed_scaffold_manifests, report_refused_writes,
    report_user_owned_skips, scaffold, stampable_output_paths, sweep_manifest_orphans, sweep_orphans,
